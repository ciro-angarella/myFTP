...
struct USER registered_user[MAX_USER] = {
                 {"enzo", "insalata", 0, -1,"FTPpath/enzo", ""},
                 {"ciro", "marika", 0, -1, "FTPpath/ciro", ""},
                 {"camilla", "vale", 0, -1, "FTPpath/camilla", ""},
                 };


char *anonDir = "FTPpath/anon"; /**< directory per tutti gli utenti anonimi */
